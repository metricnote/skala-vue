...
<template>
  <div class="practice-container">
    <h1>Day 1 - 1. 학습환경 구성</h1>
    <hr />
    <SampleOne />
    <SampleTwo />

    <h1>Day 1 - 2. Vue Directive</h1>
    <hr />
    <VueHtml />
    <VueHtmlXss />
    <VueText />
    ...
    <h1>Day 1 - 3. Vue Event Handling</h1>
    <hr />
    <EventBasic />
    <EventObject />
    <EventModifier />

    <h1>Day 1 - 4. Vue Form Handling</h1>
    <hr />
    <ModelBasic />
    <ModelForm />
    <ModelModifier />

    <h1>Day 1 - 5. Vue Style Handling</h1>
    <hr />
    <StyleScoped />

    <h1>Day 2 - 1. Reactive State</h1>
    <hr />
    <ReactiveRef />
    <ReactiveReactive />

    <h1>Day 2 - 2. Computed &amp; Watchers</h1>
    <hr />
    <ComputedBasic />
    <WatchersBasic />
    <WatchersMulti />
    ...
    <h1>Day 2 - 3. Component Lifecycle</h1>
    <hr />
    <LifecycleParent />

    <h1>Day 2 - 4. Props &amp; Emits</h1>
    <hr />
    <PropsEmitsParent />

    <h1>Day 2 - 5. Component Slot</h1>
    <hr />
    <SlotDefaultParent />
    <SlotNamedParent />
    <SlotScopedParent />
